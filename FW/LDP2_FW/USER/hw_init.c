...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(LCD_MOSI_GPIO_Port, LCD_MOSI_Pin);

  /**/
  LL_GPIO_ResetOutputPin(LCD_SCK_GPIO_Port, LCD_SCK_Pin);
  ...
  /**/
  LL_GPIO_SetPinPull(BTN_ON_GPIO_Port, BTN_ON_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinPull(EC11_BTN_GPIO_Port, EC11_BTN_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinPull(EC11_A_GPIO_Port, EC11_A_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinMode(BTN_ON_GPIO_Port, BTN_ON_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(EC11_BTN_GPIO_Port, EC11_BTN_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(EC11_A_GPIO_Port, EC11_A_Pin, LL_GPIO_MODE_INPUT);
  ...
  LL_GPIO_Init(EC11_B_GPIO_Port, &GPIO_InitStruct);
